package sg.edu.nus.se26pt03.photolearn.controller;
...
//    }
    ...
    public SwipeController(@LayoutRes int leftRevealResource, @LayoutRes int rightRevealResource) {
...
//                    }
    ...
    private LinearLayout getInflated(@LayoutRes int layoutResource, RecyclerView.ViewHolder viewHolder) {
        if (layoutResource != 0) {
            ...
            LayoutInflater layoutInflater = (LayoutInflater) itemView.getContext().getSystemService(itemView.getContext().LAYOUT_INFLATER_SERVICE);
